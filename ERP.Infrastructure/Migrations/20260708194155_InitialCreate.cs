        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CostPrice", "[CostPrice] >= 0");
                    table.CheckConstraint("CK_SellingPrice", "[SellingPrice] >= 0");
                    table.ForeignKey(
                        name: "FK_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SaleOrderDiscount", "[Discount] >= 0 AND [Discount] < 100 ");
                    table.CheckConstraint("CK_SaleOrderTotal", "[Total] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrderTotal", "[Total] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tax", "[Tax] >= 0 and [Tax] <= 100");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Settings_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SaleOrderItemDiscount", "[Discount] >=0 And [Discount] < 100");
                    table.CheckConstraint("CK_SaleOrderItemSellingPrice", "[SellingPrice] >=0  ");
                    table.CheckConstraint("CK_SaleOrderItemTotal", "[Total] >=0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PaymentAmount", "[Amount] > 0");
                    table.CheckConstraint("CK_PaymentMethod", "[PaymentMethod] in (1,2,3)");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_SalesOrders_SaleOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PurchaseOrderItemPrice", "[Price] >= 0");
                    table.CheckConstraint("CK_PurchaseOrderItemQuantity", "[Quantity] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_DeletedByUserId",
                table: "CustomerAddresses",
                column: "DeletedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhoneNumbers_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhoneNumbers_DeletedByUserId",
                table: "CustomerPhoneNumbers",
                column: "DeletedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inventories_DeletedByUserId",
                table: "Inventories",
                column: "DeletedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_CreatedByUserId",
                table: "PurchaseOrderItems",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_DeletedByUserId",
                table: "PurchaseOrderItems",
                column: "DeletedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderItems_CreatedByUserId",
                table: "SalesOrderItems",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderItems_DeletedByUserId",
                table: "SalesOrderItems",
                column: "DeletedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_DeletedByUserId",
                table: "SalesOrders",
                column: "DeletedByUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_DeletedByUserId",
                table: "Warehouses",
                column: "DeletedByUserId");
        }
